        ...
        <p className="text-lg leading-7 mb-8">
          {isTelugu ? (
            <>
              ...
              భగవద్గీత, రామాయణం, భాగవతం, శ్రీభాష్యం, భగవద్విషయము, శ్రీవచనభూషణము, ఆచార్య హృదయము వంటి అనేక సంప్రదాయ గ్రంథాలను సేవించి, ఆసక్తికలవారికి అనేకమంది కి కాలక్షేపములు సాయించు-చున్నారు.
              <br></br><br></br>
